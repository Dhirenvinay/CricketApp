class CricketMatch {
  ...
  factory CricketMatch.fromJson(Map<String, dynamic> json) {
    return CricketMatch(
        ...
        team1: json['t1'] ?? "",
        team2: json['t2'] ?? "",
        team1Image: json['t1img'] ??
            'https://images.unsplash.com/photo-1618022325802-7e5e732d97a1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1948&q=80',
        team2Image: json['t2img'] ??
            'https://images.unsplash.com/photo-1618022325802-7e5e732d97a1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1948&q=80',
        t1s: json['t1s'] ?? "",
        t2s: json['t2s'] ?? "");
  }
